...
namespace Saga.Board.Tests
{
	public static class Hoth1Placements
	{
		...
		{
			new TileTerrain { Expansion = "Core", TileId = "19", Side = "B", Width = 6, Height = 6, Rows = new[] { "..dddd", "..dd..", ".ddd..", ".dddd.", "dddddd", "dd..dd" } },
			...
			new TileTerrain { Expansion = "Hoth", TileId = "10", Side = "A", Width = 4, Height = 4, Rows = new[] { "...-", "....", "....", "-..." } },
			new TileTerrain { Expansion = "Hoth", TileId = "15", Side = "A", Width = 2, Height = 2, Rows = new[] { "..", ".." } },
			new TileTerrain { Expansion = "Hoth", TileId = "17", Side = "A", Width = 2, Height = 2, Rows = new[] { "..", ".." } },
			new TileTerrain { Expansion = "Hoth", TileId = "17", Side = "B", Width = 2, Height = 2, Rows = new[] { "..", ".." } },
			new TileTerrain { Expansion = "Hoth", TileId = "19", Side = "A", Width = 1, Height = 2, Rows = new[] { ".", "." } },
			new TileTerrain { Expansion = "Hoth", TileId = "2", Side = "A", Width = 6, Height = 6, Rows = new[] { "-...--", "......", "....dd", "....dd", "....dd", "--..d-" }, Edges = new[] { new TileEdge { C = 4, R = 1, Dir = "W", Type = EdgeType.Impassable }, new TileEdge { C = 1, R = 2, Dir = "W", Type = EdgeType.Impassable }, new TileEdge { C = 1, R = 3, Dir = "N", Type = EdgeType.Impassable }, new TileEdge { C = 2, R = 3, Dir = "N", Type = EdgeType.Impassable }, new TileEdge { C = 3, R = 3, Dir = "N", Type = EdgeType.Impassable } } },
			new TileTerrain { Expansion = "Hoth", TileId = "20", Side = "A", Width = 2, Height = 1, Rows = new[] { ".." } },
			new TileTerrain { Expansion = "Hoth", TileId = "20", Side = "B", Width = 2, Height = 1, Rows = new[] { ".." } },
